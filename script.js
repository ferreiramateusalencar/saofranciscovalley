// Dados das startups (copiados de constants.ts)
const STARTUPS = [
  { id: '1', name: 'AgroSense Vale', category: 'Agro', description: 'Otimizar o uso de recursos hídricos através de sensores IoT e IA para fruticultura de precisão no semiárido.', logo: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '2', name: 'SolarRiver', category: 'Tech', description: 'Implementar usinas fotovoltaicas flutuantes no Rio São Francisco para geração de energia limpa.', logo: 'https://images.unsplash.com/photo-1509391366360-fe5bb58583bb?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '3', name: 'VinhoTech', category: 'Tech', description: 'Rastreabilidade da cadeia produtiva de vinhos e sucos utilzando Blockchain.', logo: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '4', name: 'Sertão Saúde', category: 'Health', description: 'Conectar especialistas via plataforma de telediagnóstico.', logo: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '5', name: 'BioVale Resíduos', category: 'Impact', description: 'Transformar subprodutos da agroindústria em fertilizantes orgânicos.', logo: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '6', name: 'EducaSertão VR', category: 'Education', description: 'Educação técnica através de laboratórios virtuais de realidade aumentada para jovens rurais.', logo: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '7', name: 'Artesanato Digital', category: 'Creative Economy', description: 'Digitalizar e internacionalizar a produção das comunidades de artesãos do Vale.', logo: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?auto=format&fit=crop&q=80&w=400', website: '#' },
  { id: '8', name: 'LogVale Express', category: 'Tech', description: 'Sistema inteligente de logística reversa e última milha otimizado.', logo: 'https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&q=80&w=400', website: '#' }
];
...
function route() {
  ...
  // Se estamos na página catalogo.html explicitamente, renderiza o catálogo
  if (path.endsWith('catalogo.html') || hash.startsWith('#/catalogo')) {
    renderCatalog();
    return;
  }

  // Senão, renderiza a home
  renderHome();

  // Smooth scroll para fragmentos apenas na home
      ...
      <div class="hero-image">
        ...
        <div class="hero-image-inner">
          ...
          <div style="position:absolute;bottom:24px;left:24px;right:24px;color:#fff">
            <p style="font-size:18px;font-weight:600; color: #fff">"A infraestrutura social que o ecossistema do Vale precisava para crescer."</p>
          </div>
        </div>
      </div>
    </section>
